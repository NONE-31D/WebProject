...
<script type="text/javascript">
	function list() {
		document.listFrm.action = "../board/list.jsp";
			...
			%>
				  <table border="0" width="100%" cellpadding="2" cellspacing="0">
					...
					<tr>
						...
						<td align="center"><form name="updateFrm" method="post" action="adminBoardUpdate.jsp?nowPage=<%=nowPage%>&num=<%=num%>">
						<input type="submit" value="수정">
						<input type="hidden" name=num value=<%=num%>>
						</form>
						</td>
						<td align="center"><form name="deleteFrm" method="post" action="adminBoardDelete.jsp">
